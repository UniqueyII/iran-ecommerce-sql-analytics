...
-- This query analyzes customer lifetime value and churn risk

SELECT '=== Customer Analysis Report ===' as report_header;
...
SELECT 
    ...
    CASE 
        ...
        WHEN (CURRENT_DATE - MAX(o.order_date)::date) BETWEEN 8 AND 30 THEN '🟢 فعال اخیر'
        ELSE '🟢 بسیار فعال'
    END as "وضعیت مشتری",
